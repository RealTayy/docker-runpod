...
- Env (optional):
  ...
  - `JUPYTER_THEME` (defaults to `JupyterLab Dark`; initial JupyterLab theme)
  ...
  - `CODE_SERVER_THEME` (defaults to `Default Dark+`; controls the initial VS Code theme for code-server)
